...
angular
  ...
  .component('addBillModal', {
    ...
    controller: ['$scope', 'BillFormData',
      function addBillModalCtrl($scope, BillFormData) {
        this.FORM_NAME = 'newBillForm';

        this.hasSuccess = BillFormData.subscribeToHasSuccess(
          $scope,
          (hasSuccess) => this.hasSuccess = hasSuccess
        );
        this.isButtonDisabled = BillFormData.subscribeToIsButtonDisabled(
          $scope,
          (isButtonDisabled) => this.isButtonDisabled = isButtonDisabled
        );

        // this.resetForm = BillFormData.

        this.resetForm = BillFormData.reset;
